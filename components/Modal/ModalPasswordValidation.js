...
const ModalPasswordValidation = () => {
    return (
        <dialog id="pass_too_short" className="modal modal-bottom sm:modal-middle">
            <div className="modal-box">
                ...
                <p className="py- text-lg">Password should have at least 8 characters.</p>
...
export default ModalPasswordValidation;