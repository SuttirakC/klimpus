  ...
  return (
    <>
      <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-3xl bg-white">
        ...
        <iframe src="http://modld146.lib.kmutt.ac.th:3000/d-solo/bdk6tg5ev905cb/powermeter?orgId=1&theme=light&panelId=1" width="100%" height="100%" frameborder="0"></iframe>
        </div>
          {/* Chart */}
          {/* <div className="relative h-350-px">
