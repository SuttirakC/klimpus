...
export default function CardFlowrateLineChart({ deviceName }) {
    var src = "";
    var fl = "";
    if (deviceName == "FlowMeter_1FL") {
        src = "http://modld146.lib.kmutt.ac.th:3000/d-solo/bdk67fysuercwa/flowmeter?orgId=1&refresh=1m&from=now-1d&to=now&theme=light&panelId=8";
        fl = "1st Floor";
    }
    else if (deviceName == "FlowMeter_6FL") {
        src = "http://modld146.lib.kmutt.ac.th:3000/d-solo/bdk67fysuercwa/flowmeter?orgId=1&refresh=1m&from=now-1d&to=now&theme=light&panelId=1";
        fl = "6th Floor";
    }
    return (
        <>
